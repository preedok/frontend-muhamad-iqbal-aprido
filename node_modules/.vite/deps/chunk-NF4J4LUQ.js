...
function deepClone2(source) {
  if (React28.isValidElement(source) || (0, import_react_is3.isValidElementType)(source) || !isPlainObject2(source)) {
    return source;
  }
  const output = {};
  Object.keys(source).forEach((key) => {
...
function deepmerge2(target, source, options = {
  ...
  if (isPlainObject2(target) && isPlainObject2(source)) {
    Object.keys(source).forEach((key) => {
      if (React28.isValidElement(source[key]) || (0, import_react_is3.isValidElementType)(source[key])) {
        output[key] = source[key];
...
@mui/system/esm/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-NF4J4LUQ.js.map
